...
function withThemeFactory(BaseComponent, createElement, contextTypes) {
  return function withTheme(component) {
    ...
    var WithTheme = function (_BaseComponent) {
      ...
      function WithTheme(props, context) {
        ...
        _this.state = {
          theme: context[_themeChannel.THEME_CHANNEL] ? context[_themeChannel.THEME_CHANNEL].get() : {}
        };
        return _this;
      }
      ...
      _createClass(WithTheme, [{
        ...
        value: function componentWillMount() {
          ...
          if (this.context[_themeChannel.THEME_CHANNEL]) {
            this.unsubscribe = this.context[_themeChannel.THEME_CHANNEL].subscribe(function (properties) {
    ...
    return (0, _hoistStatics2.default)(WithTheme, component);
  };
}