...
export default function ThemeProviderFactory(BaseComponent, renderChildren, statics) {
  var ThemeProvider = function (_BaseComponent) {
    ...
    function ThemeProvider(props, context) {
      ...
      var previousTheme = !props.overwrite && _this.context[THEME_CHANNEL];
      _this.theme = createTheme(props.theme, previousTheme);
      return _this;
    }
    ...
    _createClass(ThemeProvider, [{
      ...
      value: function getChildContext() {
        return _defineProperty({}, THEME_CHANNEL, this.theme);
      }
    }, {
      key: 'render',
