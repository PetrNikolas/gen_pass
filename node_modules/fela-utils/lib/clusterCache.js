...
function clusterCache(cache) {
  ...
  var supportMediaRules = (0, _reduce2.default)(mediaQueryOrder, function (supportRules, media) {
    supportRules[media] = (0, _applyKeysInOrder2.default)(supportQueryOrder);
    return supportRules;
  }, (0, _applyKeysInOrder2.default)(mediaQueryOrder, {}));

  return (0, _reduce2.default)(cache, function (cluster, entry, key) {
